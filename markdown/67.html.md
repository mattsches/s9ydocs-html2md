...
-   **New Entry:** Create a new entry. See [Posting a Blog Entry](/39.html).
-   **Edit Entries:** Edit an existing entry.
-   **Comments:** Maintain comments posted to entries. See [Approve Comments](/68.html).
-   **Categories:** Maintain entry categories. See [Manage Categories](/69.html).
...
-   **Manage Styles:** Select and configure your site's theme/template. See [Manage Styles](/75.html).
-   **Configure Plugins:** Manage sidebar and event plugins. See [Using Plugins](/45.html).

**Administration**

-   **Configuration:** Global configuration. See [configuration](/66.html).
-   **Manage users:** Manage individual users. See [User management](/47.html).
-   **Manage groups:** Manage user groups. Also see [User management](/47.html).
-   **Import data:** Import data from another blog/cms system. See [Import/Export Entries](/103.html).
-   **Export entries:** Export data from Serendipity. See [Import/Export Entries](/103.html).
...
-   **Serendipity Documentation:** Link to Serendipity's [documentation](http://www.s9y.org/33.html) (you are here!).
